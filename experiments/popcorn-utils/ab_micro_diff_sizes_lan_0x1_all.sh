...
usr_input_name="$1"
_log_name_prefix="ab_micro_all_0x1" # just in case
...
#################3
#SIZE+="1 2 4 8 16 32 64 128 256 512 1024 2048 4096 8192 16384 65536 262144 1048576 "
#SIZE+="4 4096"
