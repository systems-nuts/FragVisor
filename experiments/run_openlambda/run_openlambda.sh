...
project_sub_folder=${project}/${TSTAMP}_${_project}_VANILLA_OPENLAMBDA #_${prefix}
...
do
	...
	for ports in 5000 5001 5002 5003
	do
		(
			curl -X POST 10.4.4.222:$ports/run/process -d '1' >> ${_project_sub_folder}/logfile.log
			echo "\n" >> ${_project_sub_folder}/logfile.log
	...
	#cat ${_project_sub_folder}/interm_out | grep "Time taken for tests" -A 17 | tee -a ${_project_sub_folder}/out
